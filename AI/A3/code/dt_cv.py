...
def cv_pre_prune(folds: List, value_list: List[float]) -> Tuple[list[float], List[float]]:
    """
...
def cv_post_prune(folds: List, value_list: List[float]) -> Tuple[list[float], List[float]]:
    """
